...
/**
 * @description 消息提示框
 * @param {Object} options 参数和 wx.showToast 参数要保持一致
 */
...
/**
 * @description 模态对话框
 * @param {Object} options 参数和 wx.showModal 参数要保持一致
 */
const modal = (options = {}) => {
...
// 如果有很多 .js 文件，都需要调用 toast方法
// 直接将 toast 方法挂载到 wx 全局对象身上，就不需要导入toast后再调用
// 注：如果想 “挂载到 wx 全局对象上” 这种写法生效，需要让当前文件执行一次import './utils/extendApi'
wx.toast = toast
wx.modal = modal
